...
<p align="center">
  <img src="https://img.shields.io/badge/AstrBot-v4.5.2%20Compatible-brightgreen.svg" alt="Compatible with AstrBot v4.5.2">
  <img src="https://img.shields.io/badge/Release-v0.9.9-brightgreen.svg" alt="Release">
...
> [!NOTE]
> 根据我对 v0.9.9 版本的简单测试，目前插件的主要功能都能正常运转，不过需要有好的提示词进行配合，才能获得理想的主动消息效果。
> 
> v0.9.9 版本下，主动消息是通过发出一条**模拟的用户消息**来实现的，因此需要配合高质量的提示词，才能避免模型的回复“出戏”。
> 
...
> 
> 如果你使用的是 V0.9.9 版本，请确保你的 AstrBot 版本大于等于 **4.5.2** ，否则无法正常导入插件。([#7](https://github.com/DBJD-CR/astrbot_plugin_proactive_chat/issues/7))
>
> 当前版本下，如果你使用**手机**给你的 Bot 发送消息，在消息输入过程中会捕抓到“对方正在输入”这一状态，导致主动消息的任务创建。这是一个近乎无害的特性，你可以利用这个特性，在不发送消息的情况下创建一个主动消息任务。以防你有疑问（例如疑惑为什么没给 Bot 发消息就触发了主动消息或触发主动消息的时间与预期不符），特此说明。
>
